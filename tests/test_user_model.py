...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_valid_email_change_token(self):
        u = User(email='gontar.ivan79@mail.ru', password='swordfish1')
        db.session.add(u)
        db.session.commit()       
        token = u.generate_email_change_token('gontar.irina84@yandex.ru')
    ...
    def invalid_email_change_token(self):
        ...
        db.session.add(u2)
        db.session.commit()
        token = u1.generate_email_change_token('gontar.ivan79@gmail.com')
        self.assertFalse(u2.change_email(token))        
        self.assertTrue(u2.email == 'gontar.irina84@yandex.ru')
    ...
    def test_duplicate_email_change_token(self):
        ...
        db.session.add(u2)
        db.session.commit()
        token = u1.generate_email_change_token('iogontar@gmail.com')
        self.assertFalse(u2.change_email(token))        
        self.assertTrue(u2.email == 'gontar.irina84@yandex.ru')
    ...
    def test_moderator_role(self):
        ...
        u = User(email='gontar.ivan79@mail.ru', password='swordfish1', role=r)
        self.assertTrue(u.can(Permission.FOLLOW))        
        self.assertTrue(u.can(Permission.COMMENT))
        self.assertTrue(u.can(Permission.WRITE_ARTICLES))
